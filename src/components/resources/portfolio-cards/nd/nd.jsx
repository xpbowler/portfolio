    ...
    return(
            <Box sx={{ flexGrow: 1, paddingLeft: "5%", paddingTop:"9em", width:'89%'}} >
                    <Typography variant="h4" p="10px 40px">
                        <a style={{color: colors.primary[100]}} rel="noreferrer" target="_blank" href="https://www.youtube.com/watch?v=H1u89yBNDfk">Video Demo of NeuroDetect</a>
                        <IconButton>
                    ...
                    summary are shown below (right): 
                        ...
                        <br/>
                        <br/>
                        <img src={rProcess} style={{width: "auto", height: "480px"}}/><img src={cnnDimensions} style={{width: "auto", height: "480px", paddingLeft:'100px'}}/>
                        <br/>
                        <br/>
                    </Typography>
